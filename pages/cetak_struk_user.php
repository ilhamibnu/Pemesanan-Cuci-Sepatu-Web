            ...
            <div id="content">
                ...
                <div class="box">
                    ...
                    <table class="table" id="tabel">
                        ...
                        <tr>
                            <td>Layanan : </td>
                            <td><?php echo $data['namalayanan'] ?> - (<?php echo $data['hargalayanan'] ?>) </td>
                        </tr>
                        <tr>
                            <td>Jumlah : </td>
                        ...
                        <tr>
                            <td>Pengiriman : </td>
                            <td><?php echo $data['jenispengiriman'] ?> - (<?php echo $data['hargapengiriman'] ?>)</td>

                        </tr>
                        <tr>
                            <td>Penjemputan : </td>
                            <td><?php echo $data['jenispenjemputan'] ?> - (<?php echo $data['hargapenjemputan'] ?>)</td>
